...
const uploader = EmberUploader.Uploader.create({
    ...
    xmlUrl: '/public/assets/detail-layout',
    ...
    actions: {
        loadSuccess: function(object, response) {
            ...
            function mapNodesToShapes(pidShapesLibrary, pidNodes) {
                console.log(
                    "Mapping nodes to vertex shapes (equipment, instrument, arrow, group)."
                );
            ...
            function generatePidXmlString(pidJson) {
                ...
                pidXmlString = `
<mxGraphModel dx="${graphSettings.dx}" dy="${graphSettings.dy}" grid="${
                    graphSettings.grid
                }" gridSize="${graphSettings.gridSize}" guides="${
                    graphSettings.guides
                }" tooltips="${graphSettings.tooltips}" connect="${
                    graphSettings.connect
                }" arrows="${graphSettings.arrows}" fold="${
                    graphSettings.fold
                }" page="${graphSettings.page}" pageScale="${
                    graphSettings.pageScale
                }" pageWidth="${graphSettings.pageWidth}" pageHeight="${
                    graphSettings.pageHeight
                }" background="${graphSettings.background}" math="${
                    graphSettings.math
                }" shadow="${graphSettings.shadow}">
  <root>
    <mxCell id="0"/>
    <mxCell id="1" parent="0"/>`;
                ...
                pidEquipments.forEach(pidEquipment => {
                    ...
                    console.log(
                        `Generating XML-tags for ${equipmentCount} equipment instances...`
                    );
                    ...
                    pidXmlString += `
    <mxCell id="${pidEquipment.id}" value="${pidEquipment._value}" style="${
                        pidEquipment._style
                    }" vertex="${pidEquipment._vertex}" parent="${
                        pidEquipment.parent
                            ? pidEquipment.parent
                            : pidEquipment._parent
                    }">
      <mxGeometry x="50" y="50" width="${
          pidEquipment.mxGeometry._width
      }" height="${pidEquipment.mxGeometry._height}" as="${
                        pidEquipment.mxGeometry._as
                    }"></mxGeometry>
    </mxCell>`;
                });
                ...
                pidInstruments.forEach(pidInstrument => {
                    ...
                    console.log(
                        `Generating XML-tags for ${instrumentCount} instrument instances...`
                    );
                    pidXmlString += `
    <mxCell id="${pidInstrument.id}" value="${pidInstrument._value}" style="${
                        pidInstrument._style
                    }" vertex="${pidInstrument._vertex}" parent="${
                        pidInstrument.parent
                            ? pidInstrument.parent
                            : pidInstrument._parent
                    }">
      <mxGeometry x="50" y="50" width="${
          pidInstrument.mxGeometry._width
      }" height="${pidInstrument.mxGeometry._height}" as="${
                        pidInstrument.mxGeometry._as
                    }"></mxGeometry>
    </mxCell>`;
                });
                ...
                pidArrows.forEach(pidArrow => {
                    ...
                    console.log(
                        `Generating XML-tags for ${arrowCount} arrow instances...`
                    );
                    pidXmlString += `
    <mxCell id="${pidArrow.id}" value="${pidArrow._value}" style="${
                        pidArrow._style
                    }" vertex="${pidArrow._vertex}" parent="${
                        pidArrow.parent ? pidArrow.parent : pidArrow._parent
                    }">
      <mxGeometry x="50" y="50" width="${pidArrow.mxGeometry._width}" height="${
                        pidArrow.mxGeometry._height
                    }" as="${pidArrow.mxGeometry._as}"></mxGeometry>
    </mxCell>`;
                });
                ...
                pidGroups.forEach(pidGroup => { // FIXME: width and height attributes set depending on group shapeName
                    ...
                    console.log(
                        `Generating XML-tags for ${groupCount} group instances...`
                    );
                    pidXmlString += `
    <mxCell id="${pidGroup.id}" value="${pidGroup._value}" style="${
                        pidGroup._style
                    }" vertex="${pidGroup._vertex}" parent="${
                        pidGroup.parent ? pidGroup.parent : pidGroup._parent
                    }">
      <mxGeometry x="0" y="0" width="${pidGroup.shapeName === "emodule_group" ? pidGroup.mxGeometry._width : graphSettings.pageWidth }" height="${
                        pidGroup.shapeName === "emodule_group" ? pidGroup.mxGeometry._height : graphSettings.pageHeight
                    }" as="${pidGroup.mxGeometry._as}"></mxGeometry>
    </mxCell>`;
                });
                ...
                pidLines.forEach(pidLine => {
                    ...
                    console.log(
                        `Generating XML-tags for ${lineCount} line instances...`
                    );
                    pidXmlString += `
    <mxCell id="${pidLine.id}" value="${pidLine._value}" style="${
                        pidLine._style
                    }" edge="${pidLine._edge}" source="${
                        pidLine.node_0
                    }" target="${pidLine.node_1}" parent="${pidLine._parent}">
